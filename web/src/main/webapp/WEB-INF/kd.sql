...
-- 테이블 데이터 kd.movie_info:~9 rows (대략적) 내보내기
INSERT INTO `movie_info` (`MI_NUM`, `MI_TITLE`, `MI_DESC`, `MI_GENRE`, `MI_CREDAT`, `MI_CNT`) VALUES
	...
	(13, '아바타:물의 길', '<아바타: 물의 길>은 판도라 행성에서 \'제이크 설리\'와 \'네이티리\'가 이룬 가족이 겪게 되는 무자비한 위협과 살아남기 위해 떠나야 하는 긴 여정과 전투, 그리고 견뎌내야 할 상처에 대한 이야기를 그렸다. 월드와이드 역대 흥행 순위 1위를 기록한 전편 <아바타>에 이어 제임스 카메론 감독이 13년만에 선보이는 영화로, 샘 워싱턴, 조 샐다나, 시고니 위버, 스티븐 랭, 케이트 윈슬렛이 출연하고 존 랜도가 프로듀싱을 맡았다.', 'S/F', '2022-12-14 00:00:00', 10800000),
	(14, '애나벨:인형의 주인', '인형장인과 그의 아내는 비극적인 사고로 어린 딸을 잃는다. 그리고 12년 후, 그 집에 고아원 소녀들과 수녀가 함께 살게 되는데… “딸을 다시 볼 수만 있다면 어떤 존재도 받아들이겠다 기도했어요. 그건 우리 꿀벌… 내 딸이 틀림없었죠. 인형 속에 들어가 평생 우리랑 있겠다더군요. 하지만 곧 내 딸이 아니란 걸 깨닫게 됐죠. 사악한 존재가 우릴 속여서 영혼을 빼앗으려고 했어요. 교회의 도움으로 악마를 인형 속에 가뒀고, 이제 사라진 줄 알았는데… 돌아왔어, 이렇게 될 줄 알았어…”', '스릴러', '2017-08-10 00:00:00', 1930000);
