...
<form>
	...
	<input type="text" placeholder="내용" name="biContent" id="biContent" value=<%=request.getParameter("biContent")==null?"":request.getParameter("biContent")%>><button>검색</button>
</form>
<table border="1">
	<tr>
		<td>번호</td>
