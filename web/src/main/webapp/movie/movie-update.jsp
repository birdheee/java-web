...
String sql = "SELECT MI_NUM, MI_TITLE, MI_GENRE, MI_CNT, DATE_FORMAT(MI_CREDAT, '%Y-%m-%d') MI_CREDAT, MI_DESC FROM MOVIE_INFO ";
sql += " WHERE MI_NUM=?";
...
<input type="hidden" name="miNum" value="<%=miNum%>">
	<table border="1">
		...
		<tr>
			<td colspan="2" align="right"><button onclick="location.href='<%=root%>/movie/movie-update-ok.jsp'">수정 완료</button></td>
		</tr>
	</table>
</form>
</body>
